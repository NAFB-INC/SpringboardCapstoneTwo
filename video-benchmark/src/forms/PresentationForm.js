...
function PresentationForm() {
    ...
    const handleSubmit = e => {
        ...
        if(newErrors.length === 0){
            try{
                setErrors([])
                let presentationCode = VideoAPI.createPresentation({
        ...
        <div className="PresentationForm">
            ...
            <form onSubmit={handleSubmit}>
                <div>
                    ...
                    <input name="presentation_title" type="text" placeholder="Major Budget Overhaul" value={formData.presentation_title} onChange={handleChange}></input>
                </div>
                <div>
                    <label htmlFor="presenter_name_first">Presenter's First Name: </label>
                    <input name="presenter_name_first" type="text" placeholder="Joe" value={formData.presenter_name_first} onChange={handleChange}></input>
                </div>
                <div>
                    <label htmlFor="presenter_name_last">Presenter's Last Name: </label>
                    <input name="presenter_name_last" type="text" placeholder="Joe" value={formData.presenter_name_last} onChange={handleChange}></input>
                </div>
                <div>
                    <label htmlFor="presenter_pass">Presenter Password: </label>
                    <input name="presenter_pass" type="password" placeholder="super secret" value={formData.presenter_pass} onChange={handleChange}></input>
                </div>
                ...
                <div>
                    ...
                    <textarea name="presentation_description" type="text" placeholder="Something needs to be done about our 1st class travel spending..." value={formData.presentation_description} onChange={handleChange}></textarea>
                </div>
                <br/>
                <div>
                        {errors.map((e)=>(
